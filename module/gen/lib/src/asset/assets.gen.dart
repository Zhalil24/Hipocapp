...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_turkey.svg
  SvgGenImage get icTurkey => const SvgGenImage('assets/icons/ic_turkey.svg');
...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/anim_work.json
  LottieGenImage get animWork =>
      const LottieGenImage('assets/lottie/anim_work.json');

  /// List of all assets
  List<LottieGenImage> get values => [animWork];
}
